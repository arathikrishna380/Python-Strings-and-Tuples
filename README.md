...
This repository contains the completed Jupyter Notebook for Python Coding, focusing on basic data structures in Python, specifically working with Strings and Tuples.
...
Launch Jupyter Notebook via Anaconda Navigator or Terminal.

Open Data Structure.ipynb and run the cells sequentially using Shift + Enter.
